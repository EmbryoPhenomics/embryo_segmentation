...
def UNet2plus(input_shape, n_classes, using_deep_supervision=False):
    ...
    nestnet_output_1 = Conv2D(n_classes, (1, 1), activation='sigmoid', name='output_1',padding='same', dtype=tf.float32)(conv1_2)
    nestnet_output_2 = Conv2D(n_classes, (1, 1), activation='sigmoid', name='output_2', padding='same', dtype=tf.float32)(conv1_3)
    nestnet_output_3 = Conv2D(n_classes, (1, 1), activation='sigmoid', name='output_3', padding='same', dtype=tf.float32)(conv1_4)
    nestnet_output_4 = Conv2D(n_classes, (1, 1), activation='sigmoid', name='output_4', padding='same', dtype=tf.float32)(conv1_5)
...
if __name__ == '__main__':
    model = UNet2plus(input_shape=(256, 256, 1), n_classes=1)
    model.summary()